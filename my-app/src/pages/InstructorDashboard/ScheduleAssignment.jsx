...
import { createAssignment } from '../../apiCalls/assignmentCalls';
...
export default function ScheduleAssignment() {
  ...
  const openQuestionModal = () => {
    setCurrentQuestion({
      questionText: '',
      questionType: formData.assignmentType === 'mixed' ? 'mcq' : formData.assignmentType,
      options: [{ optionText: '', isCorrect: false }],
      correctAnswer: '',
      points: 1
    });
  ...
  const saveQuestion = () => {
    ...
    if ((currentQuestion.questionType === 'mcq' || currentQuestion.questionType === 'multiple_correct') 
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setMessage({ type: 'success', text: result.msg || 'Assignment scheduled successfully!' });
      ...
      const errorMsg = error.errors?.[0]?.msg || error.message || 'Failed to schedule assignment';
  ...
  return (
    ...
    <div className="min-h-screen bg-[#fff8f2] p-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Schedule Assignment</h1>
          <p className="text-gray-600">Create and schedule a new assignment with questions</p>
        </div>

          <button
    onClick={() => window.location.href = '/instructor/assignments'}
    className="flex items-center gap-2 border border-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-100 transition-colors"
  >
    ← Back
  </button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6">
            ...
            <div className="space-y-4">
              ...
              {(currentQuestion.questionType === 'mcq' || currentQuestion.questionType === 'multiple_correct') && (
                <div>
